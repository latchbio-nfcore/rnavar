...
def nextflow_runtime(
    ...
    save_merged_fastq: typing.Optional[bool],
    genome: typing.Optional[str],
    fasta: typing.Optional[LatchFile],
    dict: typing.Optional[str],
    fasta_fai: typing.Optional[str],
    gtf: typing.Optional[str],
    gff: typing.Optional[str],
    exon_bed: typing.Optional[str],
    save_reference: typing.Optional[bool],
    known_indels: typing.Optional[str],
    known_indels_tbi: typing.Optional[str],
    dbsnp: typing.Optional[str],
    dbsnp_tbi: typing.Optional[str],
    ...
    star_twopass: typing.Optional[bool],
    star_ignore_sjdbgtf: typing.Optional[bool],
    seq_center: typing.Optional[str],
    save_unaligned: typing.Optional[bool],
    save_align_intermeds: typing.Optional[bool],
    bam_csi_index: typing.Optional[bool],
    remove_duplicates: typing.Optional[bool],
    skip_baserecalibration: typing.Optional[bool],
    skip_intervallisttools: typing.Optional[bool],
    skip_variantfiltration: typing.Optional[bool],
    skip_variantannotation: typing.Optional[bool],
    skip_multiqc: typing.Optional[bool],
    no_intervals: typing.Optional[bool],
    read_length: typing.Optional[float],
    aligner: typing.Optional[str],
    star_max_memory_bamsort: typing.Optional[int],
    star_bins_bamsort: typing.Optional[int],
    star_max_collapsed_junc: typing.Optional[int],
    seq_platform: typing.Optional[str],
    gatk_hc_call_conf: typing.Optional[float],
    gatk_interval_scatter_count: typing.Optional[int],
    gatk_vf_window_size: typing.Optional[int],
    gatk_vf_cluster_size: typing.Optional[int],
    gatk_vf_fs_filter: typing.Optional[float],
    gatk_vf_qd_filter: typing.Optional[float],
) -> None:
    try:
        ...
        if nextflow_log.exists():
            ...
            if name is None:
                ...
                remote = LPath(
                    urljoins(
                        "latch:///your_log_dir/nf_nf_core_rnavar", name, "nextflow.log"
                    )
                )
...
def nf_nf_core_rnavar(
    ...
    skip_multiqc: typing.Optional[bool],
    no_intervals: typing.Optional[bool],
    read_length: typing.Optional[float] = 151.0,
    aligner: typing.Optional[str] = "star",
    star_max_memory_bamsort: typing.Optional[int] = 0,
    star_bins_bamsort: typing.Optional[int] = 50,
    star_max_collapsed_junc: typing.Optional[int] = 1000000,
    seq_platform: typing.Optional[str] = "illumina",
    gatk_hc_call_conf: typing.Optional[float] = 20.0,
    gatk_interval_scatter_count: typing.Optional[int] = 25,
    gatk_vf_window_size: typing.Optional[int] = 35,
    gatk_vf_cluster_size: typing.Optional[int] = 3,
    gatk_vf_fs_filter: typing.Optional[float] = 30.0,
    gatk_vf_qd_filter: typing.Optional[float] = 2.0,
) -> None:
    """
    nf-core/rnavar
    ...
    nextflow_runtime(
        ...
        star_max_memory_bamsort=star_max_memory_bamsort,
        star_bins_bamsort=star_bins_bamsort,
        star_max_collapsed_junc=star_max_collapsed_junc,
        ...
        gatk_hc_call_conf=gatk_hc_call_conf,
        skip_baserecalibration=skip_baserecalibration,
        skip_intervallisttools=skip_intervallisttools,
        skip_variantfiltration=skip_variantfiltration,
        skip_variantannotation=skip_variantannotation,
        skip_multiqc=skip_multiqc,
        gatk_interval_scatter_count=gatk_interval_scatter_count,
        no_intervals=no_intervals,
        gatk_vf_window_size=gatk_vf_window_size,
        gatk_vf_cluster_size=gatk_vf_cluster_size,
        gatk_vf_fs_filter=gatk_vf_fs_filter,
        gatk_vf_qd_filter=gatk_vf_qd_filter,
    )
